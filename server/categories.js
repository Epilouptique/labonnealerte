...
const GROUPS = {
  ...
  'vie-locale': ['vie-locale', 'fetes', 'local', 'evenements-locaux', 'marches-locaux', 'brocantes', 'vide-greniers', 'travaux-voirie', 'coupures-circulation', 'collecte-dechets', 'dechetteries', 'piscines', 'bibliotheques', 'ecoles', 'vacances-scolaires', 'cantines', 'mairie'],
...
const ACCENTS = {
  meteo: 'météo', electricite: 'électricité', energie: 'énergie', economie: 'économie', securite: 'sécurité',
  ...
  greves: 'grèves', aerien: 'aérien', chomage: 'chômage', viabilite: 'viabilité', vulnerabilites: 'vulnérabilités',
  donnees: 'données', epargne: 'épargne', impots: 'impôts', echeances: 'échéances', declarations: 'déclarations',
